...
variable "service_account" {
  description = "Service account to use for the Cloud Run service"
  type        = string
}

variable "service_account_id" {
  description = "Service account ID to use for the Cloud Run service"
  type        = string
}
...
variable "workflow_name" {
  description = "Name of the workflow for the service"
  type        = string
}

variable "workflow_location" {
  description = "Location of the workflow for the service"
  type        = string
}

variable "firestore_database_name" {
  description = "Firestore database ID to use"
  type        = string
  default     = "storageflow"
}
